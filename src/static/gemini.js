...
class GeminiAI {
    constructor() {
        this.apiKey = 'AIzaSyD_fAtMwNhjLEy-8zsJFq-tagWIZYNgmVU';
...
class TTSService {
    constructor() {
        this.baseUrl = 'https://text-to-speech.imtranslator.net/';
    }

    speak(text, language = 'en') {
        // ImTranslatorのTTSサービスを新しいウィンドウで開く
        const encodedText = encodeURIComponent(text);
        const url = `${this.baseUrl}?text=${encodedText}&lang=${language}`;
